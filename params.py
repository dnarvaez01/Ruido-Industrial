...
class interiorParams:
    ...
    ABS = { 'Wall_N' : (0.02,0.02,0.02,0.04,0.08,0.11),
            'Wall_S' : (0.02,0.02,0.02,0.04,0.08,0.11),
            'Wall_E' : (0.02,0.02,0.02,0.04,0.08,0.11),
            'Wall_W' : (0.02,0.02,0.02,0.04,0.08,0.11),
            'Ceiling': (0.02,0.02,0.02,0.04,0.08,0.11),
            'Floor'  : (0.01,0.01,0.02,0.02,0.02,0.03)}

    SURFACE_ABS = {'Wall_N' : 210,
                   'Wall_S' : 210,
                   'Wall_E' : 140,
                   'Wall_W' : 140,
                   'Ceiling': 600,
